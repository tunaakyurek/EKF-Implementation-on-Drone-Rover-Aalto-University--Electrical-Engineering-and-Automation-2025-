...
%
% ANIMATION CONTEXT (QAV250):
% - x_true_hist is generated by integrating drone_dynamics with open-loop
%   thrust/torque commands u = [T; tau_phi; tau_theta; tau_psi] (no built-in FC).
% - x_est_hist comes from the EKF, whose prediction uses drone_dynamics_imu
%   (strapdown with IMU), and whose updates use sensor models. The animation
%   simply visualizes these histories; it does not control the vehicle.
